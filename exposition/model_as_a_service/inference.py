...
from formation_indus_ds_avancee.train_and_predict import predict, predict_with_shap
...
def predict_endpoint():
    ...
    prediction = predict(prepared_features_df, MODEL_PATH).to_json()
...
def shap_endpoint():
    ...
    prepared_features_df = prepare_features(received_data_df, training_mode=False)
    shap = predict_with_shap(prepared_features_df, MODEL_PATH)
